...
if(telNumber == null || telNumber.equals("")) return false;
        ...
        String regexp = "(^\\+\\d{12}$)|(^\\+\\(\\d{3}\\)\\d{9}$)|((^\\+\\d{1}\\(\\d{3}\\)\\d{8}$)|"
                +"(^\\+\\d{2}\\(\\d{3}\\)\\d{7}$)|(^\\+\\d{3}\\(\\d{3}\\)\\d{6}$)|(^\\+\\d{4}\\(\\d{3}\\)\\d{5}$)|"
                +"(^\\+\\d{5}\\(\\d{3}\\)\\d{4}$)|(^\\+\\d{6}\\(\\d{3}\\)\\d{3}$)|(^\\+\\d{7}\\(\\d{3}\\)\\d{2}$)|"
                +"(^\\+\\d{8}\\(\\d{3}\\)\\d$))|"
                +"((^\\(\\d{3}\\)\\d{7}$)|(^\\d{2}\\(\\d{3}\\)\\d{5}$)|(^\\d{3}\\(\\d{3}\\)\\d{4}$)|"
                +"(^\\d{4}\\(\\d{3}\\)\\d{3}$)|(^\\d{5}\\(\\d{3}\\)\\d{2}$)|(^\\d{6}\\(\\d{3}\\)\\d{1}$)|"
                +"(^\\d\\(\\d{3}\\)\\d{6}$))|"
                +"(^\\d{10})";
